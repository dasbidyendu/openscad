...
public:
  ...
  void visit(Halffacet_handle hf) { opposite_volumes.insert(hf->twin()->incident_volume()); }
...
public:
  ...
  void mark_volume(SNC_decorator& D, typename SNC_structure::Volume_handle vol_it, bool mark,
